...
import shape10 from "@/public/assets/img/shape/10.png";
import Services1TabData from "@/public/assets/jsonData/services/Services1TabData.json";
          ...
          <div className="row align-center">
            <div className="col-lg-5 mb-md-60">
              <div className="service-nav-info">
                <h4 className="sub-title">CE QUE NOUS FAISONS </h4>
                <h2>Un excellent service et soutien pour vous</h2>
                <div
